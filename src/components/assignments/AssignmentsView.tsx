          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#E2E7F0] dark:divide-[#1E293B] text-xs">
              {filteredAssignments.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-12 text-center text-[#64748B] dark:text-[#94A3B8]">
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 sm:px-6">
                        <div className="font-bold text-sm text-[#0F2044] dark:text-white truncate max-w-xs sm:max-w-md">
                          {asg.title}
                        </div>
                        <span className="inline-block mt-0.5 text-[10px] font-bold text-[#00897B] dark:text-[#00D2C4]">
                          {asg.subject}
                        </span>
                      </td>
      ...
      >
        <form onSubmit={handleCreateAssignmentSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              className="px-5 py-2 rounded-lg bg-[#00B4A6] dark:bg-[#00D2C4] hover:bg-[#009E91] dark:hover:bg-[#00B4A6] text-white dark:text-[#080D1A] text-xs font-bold shadow-xs"
            >
              Publish Assignment
            </button>
          </div>
