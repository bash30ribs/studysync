    ...
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6 animate-in fade-in duration-150">
      ...
      <div className="space-y-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1">
          <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mr-1">Subject:</span>
          <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredResources.length === 0 ? (
          <div className="col-span-full py-16 text-center text-xs text-slate-500 dark:text-slate-400 ui-card">
          ...
          filteredResources.map(res => (
            <div
              key={res.id}
              className="p-4.5 ui-card flex flex-col justify-between hover:border-teal-500/40 transition-all group"
            >
              <div>
                ...
                <h3 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white line-clamp-2 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">
                  {res.title}
                </h3>
              ...
              <div className="pt-4 mt-3 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button
                    ...
                    className="btn-secondary py-1 px-2.5 text-xs text-teal-600 dark:text-teal-300"
                  >
            ...
            <form onSubmit={handleUploadSubmit}>
              ...
              <div className="p-6 space-y-3.5">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-4 text-center bg-slate-50/50 dark:bg-slate-950/40">
                    <Upload className="w-5 h-5 mx-auto text-teal-600 dark:text-teal-400 mb-1" />
